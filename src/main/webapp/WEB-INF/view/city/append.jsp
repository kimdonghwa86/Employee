...
<div class="low">
	<div class="col-sm-6 col-sm-offset-3">
		<div class="panel panel-default">
 		<div class="panel-heading">도시입력</div>
			<pre>{{city}}</pre>
		...
		<div class="form-group">
			...
			<div data-ng-show="cityForm.name.$dirty">
				<div class="alert lert-warning" data-ng-show="cityForm.name.$error.required">필수입력항목입니다.</div>
				<div class="alert lert-warning" data-ng-show="cityForm.name.$error.maxlength">35자리까지 입력가능합니다.</div>
				</div>
			</div>
		...
		<!-- CountryCode -->
			...
			<div data-ng-show="cityForm.countryCode.$dirty">
				<div class="alert lert-warning" data-ng-show="cityForm.countryCode.$error.required">필수입력항목입니다.</div>
				<div class="alert lert-warning" data-ng-show="cityForm.countryCode.$error.maxlength
															||cityForm.countryCode.$error.minlength">3자리만 입력가능합니다.</div>
				</div> 
			</div>
		...
		<div class="form-group">
			...
			<div data-ng-show="cityForm.district.$dirty">
				<div class="alert lert-warning" data-ng-show="cityForm.district.$error.required">필수입력항목입니다.</div>
				<div class="alert lert-warning" data-ng-show="cityForm.district.$error.maxlength">20자리까지 입력가능합니다.</div>
			</div>	    
		</div>
			...
			<div data-ng-show="cityForm.population.$dirty">
				<div class="alert lert-warning" data-ng-show="cityForm.population.$error.required">필수입력항목입니다.</div>
				<div class="alert lert-warning" data-ng-show="cityForm.population.$error.max">최대값을 초과하였습니다.</div>
				<div class="alert lert-warning" data-ng-show="cityForm.population.$error.min">0이상 입력가능합니다</div>
				<div class="alert lert-warning" data-ng-show="cityForm.population.$error.number">숫자만 입력가능합니다</div>
			</div>	   
			</div>
